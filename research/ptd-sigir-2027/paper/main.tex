...
The artifact contains a JSON Schema for the run manifest and evaluation, the exact preregistration, a CSV claim--evidence ledger, deterministic generators for every manuscript table/figure, and a fail-closed validator. Figure~\ref{fig:evidence-flow} shows the promotion path. A claim remains pending if any evidence edge is absent.
